...
class loadAnswers:
    ...
    def loadAnswers(self, type, currentExamName, cam_index):
        ...
        while testing:
            ...
            while graded < 1:
                ...
                if type == 0: # Only scan correct answers
                    _, answers, group_answers, page_img, warped_imgs = omr.omr_read_correct_answers(img)
                ...
                if type == 1: # scan student's answers
                    answers1 = []
                    index, answers, group, page_img, warped_imgs = omr.omr_grade(answers1, img)
        ...
        cv2.imwrite("assets/page.png", page_img) # saves the last scanned image to display it later
